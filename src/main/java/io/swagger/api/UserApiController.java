...
//        return new ResponseEntity<List<User>>(HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<List<LoginResponseDTO>> userLogin(@Parameter(in = ParameterIn.DEFAULT, description = "required login info", required=true, schema=@Schema()) @Valid @RequestBody LoginRequestDTO body) {
        ...
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<LoginResponseDTO>>(objectMapper.readValue("[ {\n  \"user\" : {\n    \"firstName\" : \"jantje\",\n    \"lastName\" : \"schuurman\",\n    \"password\" : \"adbj23!9edus\",\n    \"dayLimit\" : 18,\n    \"id\" : 1,\n    \"userType\" : \"Employee\",\n    \"transactionLimit\" : 1000,\n    \"creationDate\" : \"2016-08-29T09:12:33.001Z\",\n    \"username\" : \"jantje93283\"\n  },\n  \"token\" : \"Nkafn39SJD935731KSDNF02948\"\n}, {\n  \"user\" : {\n    \"firstName\" : \"jantje\",\n    \"lastName\" : \"schuurman\",\n    \"password\" : \"adbj23!9edus\",\n    \"dayLimit\" : 18,\n    \"id\" : 1,\n    \"userType\" : \"Employee\",\n    \"transactionLimit\" : 1000,\n    \"creationDate\" : \"2016-08-29T09:12:33.001Z\",\n    \"username\" : \"jantje93283\"\n  },\n  \"token\" : \"Nkafn39SJD935731KSDNF02948\"\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type application/json", e);
                return new ResponseEntity<List<LoginResponseDTO>>(HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }
